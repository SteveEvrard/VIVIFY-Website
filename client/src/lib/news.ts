...
export const NEWS_POSTS: NewsPost[] = [
  ...
  {
    slug: "vivify-technology-unveils-flying-pig-1mw-containerized-hydrogen-power-system",
    title:
      "VIVIFY Technology Unveils Flying Pig™, a 1MW Containerized Hydrogen Power System Built for True Energy Independence",
    date: "2026-05-21",
    category: "Press Release",
    excerpt:
      "VIVIFY Technology unveiled the Flying Pig™, a 1MW hydrogen-powered containerized system that puts serious, scalable power anywhere it's needed — on remote job sites, in disaster zones, at forward military operations, and beyond — completely independent of the grid, the supply chain, and the old rules.",
    content: [
      "IMMEDIATE RELEASE",
      "",
      "<img src='/images/Jason-Herring-and-Flying-Pig.jpg' />",
      "",
      "SOUTH FLORIDA — America's century-old energy model has been rendered obsolete. Today, <a href='https://vivify-technology.com/'>VIVIFY Technology</a> unveiled the <a href='https://vivify-technology.com/technology#flying-pig'>Flying Pig™</a>, a 1MW hydrogen-powered containerized system that puts serious, scalable power anywhere it's needed — on remote job sites, in disaster zones, at forward military operations, and beyond — completely independent of the grid, the supply chain, and the old rules.",
      "",
      "<video controls><source src='/video/Website_AI_Final_CC_Compressed.mp4' type='video/mp4' /></video>",
      "",
      "Built from the core elements of VIVIFY's flagship <a href='https://vivify-technology.com/technology#hog'>HOG™</a> system, the Flying Pig™ brings containerized architecture. The result is a deployable power system designed for remote sites, industrial operations, behind-the-meter use, and any environment where operators need power on their terms.",
      ...
      "",
      "<a href='https://vivify-technology.com/about'>About VIVIFY Technology</a>",
